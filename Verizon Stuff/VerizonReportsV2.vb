...
#Region " Sub New (Overloaded)"
        ...
        Private Sub NewService()
            ...
            myService.username = New VerizonWebServices.string2
            myService.password = New VerizonWebServices.[string]
            myService.companyId = New VerizonWebServices.string1
            myService.username.Text = New String() {Username}
            myService.password.Text = New String() {Password}

            'Dim UserValue As New VerizonWebServices.string2
            'UserValue.Text = New String() {strUsername}

            'Dim Passwordvalue As New VerizonWebServices.[string]
            'Passwordvalue.Text = New String() {strPassword}
...
#End Region 'CreateKeywordReportRequest (Overloaded)
        ...
        Public Function ReqestDailyReportID(ByVal client As Clients) As String
            ...
            Try
                oResult = myService.scheduleReport(Param.ReportType, Param.StartDate, Param.EndDate)
            ...
            If sReportID = "" Then
                If Not IsNothing(oResult) Then sReportID = oResult
            End If
        ...
        Public Function RequestReportURL(ByVal client As Clients) As String
            ...
            Try
                Result = myService.getReportURL(client.Verizon.ReportID)
            Catch ex As Exception
            ...
            If sURL = "" Then
                If Not IsNothing(Result) Then sURL = Result
            End If
        ...
        Private Sub DeleteReport(ByVal sClientID As String, ByVal sReportID As String)
            ...
            'DK 11/08/07 removed for V2 migration
            ...
            myService.deleteReport(sReportID)
        End Sub
        ...
        Private Sub SetClient(ByVal sClientID As String)
            Dim CompanyID As New VerizonWebServices.string1
            CompanyID.Text = New String() {sClientID}
            myService.companyId = CompanyID
        End Sub
        '=============================================================================
