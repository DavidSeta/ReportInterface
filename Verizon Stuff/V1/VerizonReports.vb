...
Namespace VerizonWebServices
    Public Class VerizonReports
        Private WithEvents myService As VerizonWebServices.spService
...
#Region " Sub New (Overloaded)"
        ...
        Private Sub NewService()
            ...
            myService = New VerizonWebServices.spService

            Dim UserValue As New VerizonWebServices.username
            UserValue.Text = New String() {Username}

            Dim Passwordvalue As New VerizonWebServices.password
